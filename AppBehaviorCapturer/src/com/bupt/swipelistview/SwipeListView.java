...
public class SwipeListView extends ListView {
    ...
    */
    ...
    private void init(AttributeSet attrs) {
        ...
        if (swipeFrontView == 0 || swipeBackView == 0) {//载入
            ...
            if (swipeFrontView == 0 || swipeBackView == 0) {//报错
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        adapter.registerDataSetObserver(new DataSetObserver() {//注册一个观察者
     ...
     */
    protected void onListChanged() {//死循环??
        if (swipeListViewListener != null) {
