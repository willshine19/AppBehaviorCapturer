...
public class AboutDialog extends DialogFragment {
     ...
     */
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {//首次使用加载对话框

        final CheckBox checkBox = new CheckBox(getActivity());//勾选
        checkBox.setText(R.string.dontShow);//不再显示
