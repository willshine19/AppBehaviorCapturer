...
public class SettingsManager {//设置界面的数据读写,父类
    ...
    private int swipeMode = SwipeListView.SWIPE_MODE_RIGHT;//SWIPE_MODE_BOTH
    private boolean swipeOpenOnLongPress = true;
    private boolean swipeCloseAllItemsWhenMoveList = true;
    private long swipeAnimationTime = 200;
    private float swipeOffsetLeft = 34;
    private float swipeOffsetRight = 34;
